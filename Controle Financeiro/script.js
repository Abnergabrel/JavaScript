...
function inserirItem(item, indice) {
    ...
    linha.innerHTML = `
        ...
        <td>R$ ${item.valor}</td>
        <td calss="coluna-tipo"><p>${iconeTipo}</p></td>
...
function calcularTotal() {
    ...
    spanEntrada.innerHTML = totalEntradaFixado
